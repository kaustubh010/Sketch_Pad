      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col space-x-5 items-center justify-center -mt-16 text-center w-full h-[100vh]">
          ...
          <div className="texts flex flex-col justify-center items-center">
            <BoxReveal boxColor={"#c85454"} duration={0.5}><h1 className="text-slate-900 text-3xl md:text-5xl font-bold">The Sketch Pad</h1></BoxReveal>
            <BoxReveal boxColor={"#c85454"} duration={0.5}><p className="w-[90vw] md:w-[50vw] font-bold text-lg text-slate-800 mt-2">Welcome to my portfolio! The Sketch Pad showcases my entire body of work, allowing you to explore my previous sketches and illustrations. You can also commission me to create a custom sketch just for you.</p></BoxReveal>
          </div>
        </div>
      </div>
      <div className="comtainer w-[90vw] md:w-[95vw] flex flex-col justify-center items-center mx-auto">
        <BoxReveal boxColor={"#c85454"} duration={0.5}><h1 className="text-slate-900 text-3xl font-bold md:text-5xl mb-10">My Work</h1></BoxReveal>
